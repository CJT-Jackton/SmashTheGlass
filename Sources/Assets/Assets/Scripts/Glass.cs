    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.D))
        {
            if (!_broken)
            {
                ...
                //test[0] = new Vector2(-0.5f, 0.5f);
                //test[1] = new Vector2(0.5f, 0.5f);
                //test[2] = new Vector2(0.5f, -0.5f);
                //test[3] = new Vector2(-0.5f, -0.5f);
                //test[4] = new Vector2(-0.5f, -0.8f);
                //test[0] = new Vector2(0.0f, 0.2f);
                //test[1] = new Vector2(-0.3f, 0.5f);
                //test[2] = new Vector2(0.3f, 0.5f);
                //test[3] = new Vector2(0.6f, -0.7f);
                //test[4] = new Vector2(-0.5f, -0.8f);
                //test[5] = new Vector2(0.6f, 0.7f);
                //test[6] = new Vector2(-0.8f, -0.3f);
                //test[7] = new Vector2(-0.8f, 0.4f);
                //test[8] = new Vector2(0.8f, -0.2f);
                //test[9] = new Vector2(0.0f, 0.0f);
